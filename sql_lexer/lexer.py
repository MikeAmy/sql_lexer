...
#
# This module is part of python-sql_lexer and is released under
...
from sql_lexer.keywords import KEYWORDS, KEYWORDS_COMMON
...
class Lexer(object):
    ...
    def add_filter(self, filter_, **options):
        from sql_lexer.filters import Filter
